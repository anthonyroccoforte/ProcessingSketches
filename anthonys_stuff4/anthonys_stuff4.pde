...
void setup() {
  ...
  rainbow = loadImage("anthonys stuff2.png");  // 2. Change this to match your file name. 
  ...
  unicorn = loadImage("anthonys stuff3.jpeg"); // 5. Change this to match your file name.
}
